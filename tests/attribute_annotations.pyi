...
field26: int = 0xFFFFFFFFF  # Y054 Only numbers with a string representation <=10 characters long are permitted
field27: int = 12345678901  # Y054 Only numbers with a string representation <=10 characters long are permitted
field28: int = -0xFFFFFFFFF  # Y054 Only numbers with a string representation <=10 characters long are permitted
field29: int = -12345678901  # Y054 Only numbers with a string representation <=10 characters long are permitted
...
class Foo:
    ...
    field27 = 0xFFFFFFFFF  # Y052 Need type annotation for "field27" # Y054 Only numbers with a string representation <=10 characters long are permitted
    field28 = 12345678901  # Y052 Need type annotation for "field28" # Y054 Only numbers with a string representation <=10 characters long are permitted
    field29 = -0xFFFFFFFFF  # Y052 Need type annotation for "field29" # Y054 Only numbers with a string representation <=10 characters long are permitted
    field30 = -12345678901  # Y052 Need type annotation for "field30" # Y054 Only numbers with a string representation <=10 characters long are permitted
