...
def f220(x=MyEnum.VAL) -> None: ...  # Y014 Only simple default values allowed for arguments
def f221(x: MyEnum = MyEnum.VAL) -> None: ...
def f222(x: MyEnum = MyEnum.val) -> None: ...
def f223(x: MyEnum | int = MyEnum.VAL) -> None: ...
def f224(x: int | MyEnum = MyEnum.VAL) -> None: ...
def f225(x: int = MyEnum.VAL) -> None: ...  # Y011 Only simple default values allowed for typed arguments
def f226(x: MyEnum = MyEnum.foo.bar) -> None: ...  # Y011 Only simple default values allowed for typed arguments
def f227(x: NS.MyEnum = NS.MyEnum.VAL) -> None: ...
def f228(x: NS.MyEnum = {"x": MyEnum.VAL}) -> None: ...  # Y011 Only simple default values allowed for typed arguments

F220 = MyEnum.VAL
F221: MyEnum = MyEnum.VAL
F225: NS = MyEnum.VAL  # Y015 Only simple default values are allowed for assignments
