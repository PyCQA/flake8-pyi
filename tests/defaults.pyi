...
def f901(x, y: str = os.pathsep) -> None: ...
...
def f225(x: int = MyEnum.VAL) -> None: ...
def f226(x: MyEnum = MyEnum.foo.bar) -> None: ...
def f227(x: NS.MyEnum = NS.MyEnum.VAL) -> None: ...
def f228(x: NS.MyEnum = {"x": MyEnum.VAL}) -> None: ...

F220 = MyEnum.VAL
F221: MyEnum = MyEnum.VAL
F225: NS = MyEnum.VAL
F228: NS.MyEnum = {"x": MyEnum.VAL}
F901: float = os.pathsep
