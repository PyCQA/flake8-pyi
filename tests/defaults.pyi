...
def f208(x: float = math.nan) -> None: ...  # Y011 Only simple default values allowed for typed arguments
def f209(x: float = float("inf")) -> None: ...  # Y011 Only simple default values allowed for typed arguments
def f3(*, x: int = ...) -> None: ...
