...
def f6_pipe(x: type[int] | type[str] | type[float]) -> None: ...  # Y055 Multiple "type[C]" members in a union. Use a single type expression, e.g. "type[int | str | float]".
def f7_pipe(x: type[int] | str | type[float]) -> None: ...  # Y055 Multiple "type[C]" members in a union. Combine them into one, e.g. "type[int | float]".
def f8_pipe(x: builtins.type[int] | builtins.type[str] | builtins.type[float]) -> None: ...  # Y055 Multiple "type[C]" members in a union. Use a single type expression, e.g. "type[int | str | float]".
def f9_pipe(x: builtins.type[int] | str | builtins.type[float]) -> None: ...  # Y055 Multiple "type[C]" members in a union. Combine them into one, e.g. "type[int | float]".
def f10_pipe(x: type[int] | builtins.type[float]) -> None: ...  # Y055 Multiple "type[C]" members in a union. Use a single type expression, e.g. "type[int | float]".
...
def f12_pipe(x: typing.Type[int] | typing.Type[str]) -> None: ...  # noqa: Y022
def f13_pipe(x: Type_[int] | Type_[str]) -> None: ...
def f14_pipe(x: typing_extensions.Type[int] | typing_extensions.Type[str]) -> None: ...  # noqa: Y022
...
def f6_union(x: Union[type[int], type[str], type[float]]) -> None: ...  # Y055 Multiple "type[C]" members in a union. Use a single type expression, e.g. "type[Union[int, str, float]]".
def f7_union(x: Union[type[int], str, type[float]]) -> None: ...  # Y055 Multiple "type[C]" members in a union. Combine them into one, e.g. "type[Union[int, float]]".
def f8_union(x: Union[builtins.type[int], builtins.type[str], builtins.type[float]]) -> None: ...  # Y055 Multiple "type[C]" members in a union. Use a single type expression, e.g. "type[Union[int, str, float]]".
def f9_union(x: Union[builtins.type[int], str, builtins.type[float]]) -> None: ...  # Y055 Multiple "type[C]" members in a union. Combine them into one, e.g. "type[Union[int, float]]".
def f10_union(x: Union[type[int], builtins.type[float]]) -> None: ...  # Y055 Multiple "type[C]" members in a union. Use a single type expression, e.g. "type[Union[int, float]]".
# typing.Type and typing_extensions.Type are intentionally excluded from Y055
# The following type annotations should not generate any Y055 errors
def f11_union(x: Union[Type[int], Type[str]]) -> None: ...
def f12_union(x: Union[typing.Type[int], typing.Type[str]]) -> None: ...  # noqa: Y022
def f13_union(x: Union[Type_[int], Type_[str]]) -> None: ...
def f14_union(x: Union[typing_extensions.Type[int], typing_extensions.Type[str]]) -> None: ...  # noqa: Y022
...
DoublyNestedAlias: TypeAlias = Union[type[str], type[float] | type[bytes]]  # Y055 Multiple "type[C]" members in a union. Use a single type expression, e.g. "type[float | bytes]".
# typing.Type and typing_extensions.Type are intentionally excluded from Y055
DoublyNestedAlias2: TypeAlias = Union[Type[str], typing.Type[float], Type_[bytes], typing_extensions.Type[complex]]  # noqa: Y022
